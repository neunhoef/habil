...
algorithm, where $m$ is the number of generators, to find a nontrivial
...
\pagebreak
We now apply the previous theorem to matrix groups by considering their
action on vectors.
...
The field $L$ needs not contain $F$. However,  the elements of $B$ corresponding
