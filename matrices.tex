...
about $1600$ there is no point in using the Strassen/Winograd method at all, 
...
The behaviour for other finite fields is similar. The {\cvec} package
...
The dash for $q=17$ means that the Winograd method is not used for matrices
over the field with $17$ elements.
