...
Theoretically from the technical specifications of main memory and second
...
\begin{center}
\begin{picture}(0,0)%
\pgfdeclareimage{grease_pstex}{grease_pstex}%
\pgfuseimage{grease_pstex}%
\end{picture}%
...
of square matrices.
This latter method produces cache locality
...
\pgfdeclareimage[width=14cm]{matmulF2grease}{matmulF2grease}
\pgfuseimage{matmulF2grease}
\end{center}
\end{figure}
...
\pgfdeclareimage[width=14cm]{matmulF2grease_scaled}{matmulF2grease_scaled}
\pgfuseimage{matmulF2grease_scaled}
\end{center}
\end{figure}
...
\begin{center}
%\includegraphics[width=14cm]{matmulF2_all}
\pgfdeclareimage[width=14cm]{matmulF2_all}{matmulF2_all}
\pgfuseimage{matmulF2_all}
\end{center}
\end{figure}
...
\pgfdeclareimage[width=14cm]{matmulF3_all}{matmulF3_all}
\pgfuseimage{matmulF3_all}
\end{center}
\end{figure}
