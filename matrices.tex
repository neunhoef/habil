...
of compressed vectors in the {\sf GAP} kernel written by Steve Linton
(see \cite{GAP4}).
...
equipped with $\ldots$ memory modules, which explains the differences
in memory throughputs.
% FIXME: add memory information
