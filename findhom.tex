...
\desc{
A subgroup $G < \GG$ lies in class \CC6 if $n=r^m$ for a prime $r$ and
one of the two following holds:
\begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}
\item $r$ is odd and $G$ has a normal subgroup $E$ that 
is an extraspecial $r$-group of order $r^{1+2m}$ and exponent $r$.
\item $r=2$ and $G$ has a normal subgroup $E$ that is either
...
\stru
Every such group is conjugate in $\GG$ to ...
...
$n=r^{k/2}$. Since $G$ normalises $E$ it lies in \CC6 with odd $r$.
...
$n = 2^{k/2}$. Since $G$ normalises $E$ it lies in \CC6 with $r=2$.
