...
By hypothesis, the matrix representations $D$ and $D^g$ of $N$
...
are equal to $T^{-1}cT$. Since $D^g(h) = T^{-1} \cdot D(h)\cdot T$ for all
$h \in N$, we get that $T^{-1}cT$ commutes with all $D^g(h) = D(g^{-1}hg)$
